...
class FoodRestrictionsScreen extends StatefulWidget {
  FoodRestrictionsScreen({super.key, required this.topics});
  SearchTopics topics;

  @override
  _FoodRestrictionsScreenState createState() => _FoodRestrictionsScreenState(topics);
}

class _FoodRestrictionsScreenState extends State<FoodRestrictionsScreen> {
  _FoodRestrictionsScreenState(this.restrictionsTopics);

  SearchTopics restrictionsTopics;
                      ...
                      children: [
                        ...
                        ButtonTheme(
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                restrictionsTopics.restrictions = restrictions; 
                              });
                              print(">>>>>>>>>>>>>>$restrictions");
                              print(">>>>>>>>>>>>>>:::::${restrictionsTopics.restrictions}");
                              Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SpecialDishesScreen(topics: restrictionsTopics,),
                              ),
                            );},
                            child: Text("Avançar"),
                          ),
